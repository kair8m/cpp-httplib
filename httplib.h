...
namespace httplib {
    ...
    public:
        ...
        void add_global_header(const char* key, const char* val);
        void remove_global_header(const char* key);
    ...
    inline void httplib::Server::add_global_header(const char* key, const char* val)
    {
        global_headers.emplace(key, val);
    }

    inline void httplib::Server::remove_global_header(const char* key)
    {
        global_headers.erase(key);
    }
